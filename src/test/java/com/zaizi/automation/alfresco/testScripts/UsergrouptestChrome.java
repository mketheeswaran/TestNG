...
public class UsergrouptestChrome {
...

	{
		...
		parent=extent.startTest("<b>User Group Test in Chrome</b>","This is group Test,<b>Create the group,Edit the Group Name,Delete the group</b>");
	...
	@Test(retryAnalyzer=ChromeRetryAnalyzer.class,testName = "Create Group in Chrome",priority = 1)
